...
export default function FunctionalBigCard() {
    return (
        <div>
           <div className="grid m-8 lg:grid-cols-2 xl:grid-cols-5">

             <div className=" border-8 px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:px-12 lg:py-24 lg:max-w-full xl:mr-0 xl:col-span-2">
            
              <div className="xl:max-w-xl">
                
                    
                    <img className='mt-6   sm:mt-8 sm:h-64 sm:w-full sm:object-cover object-center lg:hidden' src={pic} alt=""/>
                    </div>
